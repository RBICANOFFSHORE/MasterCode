...
//	     s.click(OkCred.similar((float)0.6));
  	     Thread.sleep(9000);
	     s.wait(UpdateQST, 3000);  //FROM HERE
	    ...
	    File Source = new File("ReleasePin.png");
	      ...
	      image.setDatapath("C:\\Users\\390078\\git\\Tim_Hortons_NextGen\\tessdata");
		  ...
		  {	 
		     ...
		     String imagePath = capture(rectangle).save(System.getProperty("user.dir")+"/Image/", "SausageBiscuitPrice");
		      ITesseract image = new Tesseract();
		      image.setDatapath("C:\\Users\\390078\\git\\Tim_Hortons_NextGen\\tessdata");
		     ...
		     /* try{
		      ...
		      s.wait(VoidItem, 600);
		      s.click(VoidItem.similar((float)0.6));
		  }
	  	@Test(priority = 3)
		  ...
		  {	 
		     ...
		     Rectangle rectangle=new Rectangle();
		     rectangle.setBounds(420,200,60,30);
		     String imagePath = capture(rectangle).save(System.getProperty("user.dir")+"/Image/", "BaconBeltPrice");
		      ITesseract image = new Tesseract();
		      image.setDatapath("C:\\Users\\390078\\git\\Tim_Hortons_NextGen\\tessdata");
		      String imageText=image.doOCR(new File(imagePath));
		      System.out.println(imageText);
		  ...
		  {	 
		     ...
		     Rectangle rectangle=new Rectangle();
		     rectangle.setBounds(420,200,60,30);
		     String imagePath = capture(rectangle).save(System.getProperty("user.dir")+"/Image/", "LGCoffeePrice");
		      ITesseract image = new Tesseract();
		      image.setDatapath("C:\\Users\\390078\\git\\Tim_Hortons_NextGen\\tessdata");
		      String imageText=image.doOCR(new File(imagePath));
		      System.out.println(imageText);
		  ...
		  {	 
		     ...
		     Rectangle rectangle=new Rectangle();
		     rectangle.setBounds(420,200,60,30);
		     String imagePath = capture(rectangle).save(System.getProperty("user.dir")+"/Image/", "RefillSmallCoffeePrice");
		      ITesseract image = new Tesseract();
		      image.setDatapath("C:\\Users\\390078\\git\\Tim_Hortons_NextGen\\tessdata");
		      String imageText=image.doOCR(new File(imagePath));
		      System.out.println(imageText);
		  ...
		  {	 
		     ...
		     Rectangle rectangle=new Rectangle();
		     rectangle.setBounds(420,200,60,30);
		     String imagePath = capture(rectangle).save(System.getProperty("user.dir")+"/Image/", "RefillMediumCoffeePrice");
		      ITesseract image = new Tesseract();
		      image.setDatapath("C:\\Users\\390078\\git\\Tim_Hortons_NextGen\\tessdata");
		      String imageText=image.doOCR(new File(imagePath));
		      System.out.println(imageText);
		  ...
		  {	 
		     ...
		     Rectangle rectangle=new Rectangle();
		     rectangle.setBounds(420,200,60,30);
		     String imagePath = capture(rectangle).save(System.getProperty("user.dir")+"/Image/", "RefillLargeCoffeePrice");
		      ITesseract image = new Tesseract();
		      image.setDatapath("C:\\Users\\390078\\git\\Tim_Hortons_NextGen\\tessdata");
		      String imageText=image.doOCR(new File(imagePath));
		      System.out.println(imageText);
		  ...
		  {	 
		     ...
		     Rectangle rectangle=new Rectangle();
		     rectangle.setBounds(420,200,60,30);
		     String imagePath = capture(rectangle).save(System.getProperty("user.dir")+"/Image/", "SmallDarkRoastPrice");
		      ITesseract image = new Tesseract();
		      image.setDatapath("C:\\Users\\390078\\git\\Tim_Hortons_NextGen\\tessdata");
		      String imageText=image.doOCR(new File(imagePath));
		      System.out.println(imageText);
		  ...
		  {	 
		     ...
		     Rectangle rectangle=new Rectangle();
		     rectangle.setBounds(420,200,60,30);
		     String imagePath = capture(rectangle).save(System.getProperty("user.dir")+"/Image/", "MediumDarkRoastPrice");
		      ITesseract image = new Tesseract();
		      image.setDatapath("C:\\Users\\390078\\git\\Tim_Hortons_NextGen\\tessdata");
		      String imageText=image.doOCR(new File(imagePath));
		      System.out.println(imageText);
		  ...
		  {	 
		     ...
		     Rectangle rectangle=new Rectangle();
		     rectangle.setBounds(420,200,60,30);
		     String imagePath = capture(rectangle).save(System.getProperty("user.dir")+"/Image/", "LargeDarkRoastPrice");
		      ITesseract image = new Tesseract();
		      image.setDatapath("C:\\Users\\390078\\git\\Tim_Hortons_NextGen\\tessdata");
		      String imageText=image.doOCR(new File(imagePath));
		      System.out.println(imageText);
		  ...
		  {	 
		     ...
		     Rectangle rectangle=new Rectangle();
		     rectangle.setBounds(420,200,60,30);
		     String imagePath = capture(rectangle).save(System.getProperty("user.dir")+"/Image/", "SmallRefillDarkRoastPrice");
		      ITesseract image = new Tesseract();
		      image.setDatapath("C:\\Users\\390078\\git\\Tim_Hortons_NextGen\\tessdata");
		      String imageText=image.doOCR(new File(imagePath));
		      System.out.println(imageText);
		  ...
		  {	 
		     ...
		     Rectangle rectangle=new Rectangle();
		     rectangle.setBounds(420,200,60,30);
		     String imagePath = capture(rectangle).save(System.getProperty("user.dir")+"/Image/", "SmallSpecialtyTeaPrice"); 
		      ITesseract image = new Tesseract();
		      image.setDatapath("C:\\Users\\390078\\git\\Tim_Hortons_NextGen\\tessdata");
		      String imageText=image.doOCR(new File(imagePath));
		      System.out.println(imageText);
		  ...
		  {	 
		     ...
		     Rectangle rectangle=new Rectangle();
		     rectangle.setBounds(420,200,60,30);
		     String imagePath = capture(rectangle).save(System.getProperty("user.dir")+"/Image/", "MediumSpecialtyTeaPrice"); 
		      ITesseract image = new Tesseract();
		      image.setDatapath("C:\\Users\\390078\\git\\Tim_Hortons_NextGen\\tessdata");
		      String imageText=image.doOCR(new File(imagePath));
		      System.out.println(imageText);
		...
		public void sikuliTestCase016()throws FindFailed, IOException, TesseractException, InterruptedException
		{
		     ...
		     Rectangle rectangle=new Rectangle();
		     rectangle.setBounds(420,200,60,30);
		     String imagePath = capture(rectangle).save(System.getProperty("user.dir")+"/Image/", "SteepedTeaSmallPrice");
			 ITesseract image = new Tesseract();
			 image.setDatapath("C:\\Users\\390078\\git\\Tim_Hortons_NextGen\\tessdata");
			 String imageText=image.doOCR(new File(imagePath));
			 System.out.println(imageText);
		...
		public void sikuliTestCase017()throws FindFailed, IOException, TesseractException, InterruptedException
		{
		     ...
		     Rectangle rectangle=new Rectangle();
		     rectangle.setBounds(420,200,60,30);
		     String imagePath = capture(rectangle).save(System.getProperty("user.dir")+"/Image/", "SteepedTeaMediumPrice");		 
			 ITesseract image = new Tesseract();
			 image.setDatapath("C:\\Users\\390078\\git\\Tim_Hortons_NextGen\\tessdata");
			 String imageText=image.doOCR(new File(imagePath));
			 System.out.println(imageText);
		...
		public void sikuliTestCase018()throws FindFailed, IOException, TesseractException, InterruptedException
		{
		     ...
		     Rectangle rectangle=new Rectangle();
		     rectangle.setBounds(420,200,60,30);
		     String imagePath = capture(rectangle).save(System.getProperty("user.dir")+"/Image/", "SteepedTeaLargePrice");				 
			 ITesseract image = new Tesseract();
			 image.setDatapath("C:\\Users\\390078\\git\\Tim_Hortons_NextGen\\tessdata");
			 String imageText=image.doOCR(new File(imagePath));
			 System.out.println(imageText);
...
public void sikuliTestCase019()throws FindFailed, IOException, TesseractException, InterruptedException
{
     ...
     Rectangle rectangle=new Rectangle();
     rectangle.setBounds(420,200,60,30);
     String imagePath = capture(rectangle).save(System.getProperty("user.dir")+"/Image/", "SteepedTeaSmallRefillPrice");
...
public void sikuliTestCase021()throws FindFailed, IOException, TesseractException, InterruptedException
{
     ...
     Rectangle rectangle=new Rectangle();
     rectangle.setBounds(420,200,60,30);
     String imagePath = capture(rectangle).save(System.getProperty("user.dir")+"/Image/", "SteepedTeaLargeRefillPrice");
...
public void sikuliTestCase022()throws FindFailed, IOException, TesseractException, InterruptedException
{
     ...
     Rectangle rectangle=new Rectangle();
     rectangle.setBounds(420,200,60,30);
     String imagePath = capture(rectangle).save(System.getProperty("user.dir")+"/Image/", "SmallLattePrice");
...
public void sikuliTestCase023()throws FindFailed, IOException, TesseractException, InterruptedException
{
     ...
     Rectangle rectangle=new Rectangle();
     rectangle.setBounds(420,200,60,30);
     String imagePath = capture(rectangle).save(System.getProperty("user.dir")+"/Image/", "LargeLattePrice");
...
{     
   ...
   Rectangle rectangle=new Rectangle();
   rectangle.setBounds(420,200,60,30);
   String imagePath = capture(rectangle).save(System.getProperty("user.dir")+"/Image/", "BlueberryTimbitsPrice");
